        ...
        <form action="login.do" method="post">
            <table>
                <tr>
                    ...
                    <td colspan="2"><input name="admin_code" value="${code}" type="text" class="width150" /></td>
                ...
                <tr>
                    ...
                    <td><img src="<%=path %>/images/valicode.jpg" alt="验证码" title="点击更换" /></td>  
                ...
                <tr>
                    ...
                    <td class="login_button" colspan="2">
                        ...
                        <!-- 另一种javascript使用方式 -->
                         <a href="javascript:document.forms[0].submit();"><img src="<%=path %>/images/login_btn.png" /></a>
                    </td>    
